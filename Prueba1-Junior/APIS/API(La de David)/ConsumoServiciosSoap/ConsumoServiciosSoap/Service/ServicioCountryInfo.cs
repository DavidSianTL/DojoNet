...
namespace ConsumoServiciosSoap.Servicios
{
	...
	public interface ICountryInfoService
	{
		...
		Task<string> ConsultarBanderaPorCodigoPais(string codigoPais);
	}
	...
	public class ServicioCountryInfo: ICountryInfoService
	{
		...
		public async Task<string> ConsultarBanderaPorCodigoPais(string codigoPais)
		{
			try
			{
				var cliente = new CountryInfoServiceSoapTypeClient(
			...
			catch (Exception ex)
			{
				...
				return $"Error al obtener la bandera el pais: {ex.Message}";
			}
		}
