...
namespace ProyectoDojoGeko.Controllers
{
    ...
    public class DepartamentosEmpresaController : Controller
    {
        ...
        public DepartamentosEmpresaController(
            daoDepartamentosEmpresaWSAsync daoDepartamentosEmpresa,
        ...
        {
            _daoDepartamentosEmpresa = daoDepartamentosEmpresa;
        ...
        public async Task<IActionResult> Index()
        {
            ...
            {
                // En caso de error, registrar usando el servicio de logging
                await RegistrarError("Vista Departamentos Empresa", e);
