...
namespace RetoCRUDEmpleados.Controllers
{
    public class EmpleadowsController : Controller
    {
        ...
        // Instanciamos el DAO
        private readonly daoEmpleadoWSAsync _daoEmpleados;
        ...
        public EmpleadowsController()
        {
            ...
            _daoEmpleados = new daoEmpleadoWSAsync(_connectionString);
        }
        ...
        [HttpPost]
        public async Task<IActionResult> Crear(EmpleadoWSViewModel empleado)
        {
            try
            {
        ...
        [HttpPost]
        public async Task<ActionResult> Editar(EmpleadoWSViewModel empleado)
        {
