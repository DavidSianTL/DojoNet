...
namespace SistemaAutenticacion.Migrations
{
    ...
    [Migration("20250520212407_PrecisionPrecioEnProductos")]
    partial class PrecisionPrecioEnProductos
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SistemaAutenticacion.Models.CustomRolUsuarioViewModel", b =>
                {
                    ...
                    b.Property<string>("UsuarioViewModelId")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("SistemaAutenticacion.Models.PermisosViewModel", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityRoleClaim<string>", b =>
                {
                    b.HasOne("SistemaAutenticacion.Models.CustomRolUsuarioViewModel", null)
                        .WithMany()
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("SistemaAutenticacion.Models.UsuarioViewModel", null)
                        .WithMany()
            ...
            modelBuilder.Entity("SistemaAutenticacion.Models.CustomRolUsuarioViewModel", b =>
                {
                    b.HasOne("SistemaAutenticacion.Models.UsuarioViewModel", null)
                        .WithMany("Roles")
                        .HasForeignKey("UsuarioViewModelId");
                });

            modelBuilder.Entity("SistemaAutenticacion.Models.PermisosRolViewModel", b =>
                {
                    b.HasOne("SistemaAutenticacion.Models.PermisosViewModel", "Permiso")
