...
namespace ConsumoServiciosSoap.Servicios
{
    ...
    public interface ICountryInfoService
    {
        ...
        Task<string> ConsultarLenguajePorCodigo(string codigoLenguaje);
        Task<string> ConsultarLenguajePorNombre(string nombreLenguaje);
        ...
        public class ServicioCountryInfo : ICountryInfoService
        {
            ...
            //Devuelve una lista de lenguajes por nombre
            public async Task<List<string>> ListOfLanguagesByName()
            {
                ...
                try
                {
                    ...
                    //Retornar el resultado
                    foreach (var item in resultado.Body.ListOfLanguagesByNameResult)
                    {
                        //Agregar a la lista los parametros devueltos por el servicio
                        lenguajes.Add($"{item.sISOCode} - {item.sName}");
                    }
                }
                catch (Exception ex)
                {
                    lenguajes.Add($"Error al obtener los lenguajes: {ex.Message}");
                }

                return lenguajes;
            }

            //Devuelve una lista de lenguajes por medio del código ISO del lenguaje
            public async Task<List<string>> ListOfLanguagesByCode()
            {
                var lenguajes = new List<string>();
                try
                {
                    ...
                    //Retornar el resultado
                    foreach (var item in resultado.Body.ListOfLanguagesByCodeResult)
                    {
                        //Agregar a la lista los parametros devueltos por el servicio
                        lenguajes.Add($"{item.sISOCode} - {item.sName}");
                    }
            ...
            //Busca en la base de datos un lenguaje por el código ISO 
            public async Task<string> ConsultarLenguajePorCodigo(string codigoLenguaje)
            {
                try
                {
                    var cliente = new CountryInfoServiceSoapTypeClient(
                    ...
                    codigoLenguaje = codigoLenguaje.ToUpper();

                    var resultado = await cliente.LanguageNameAsync(codigoLenguaje);
                ...
                {
                    return $"Error al consultar el lenguaje: {ex.Message}";
                }
            }

            //Buscar el código ISO del lenguaje por medio del nombre
            public async Task<string> ConsultarLenguajePorNombre(string nombreLenguaje)
            {
                try
                {
                    var cliente = new CountryInfoServiceSoapTypeClient(
                    ...
                    nombreLenguaje = nombreLenguaje.ToUpper();

                    var resultado = await cliente.LanguageISOCodeAsync(nombreLenguaje);
            ...
            //Buscar el nombre de la capital por medio del codigo ISO
