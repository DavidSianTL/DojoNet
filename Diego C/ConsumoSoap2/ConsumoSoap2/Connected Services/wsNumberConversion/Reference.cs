...
namespace wsNumberConversion
{
    
    
    [System.CodeDom.Compiler.GeneratedCodeAttribute("Microsoft.Tools.ServiceModel.Svcutil", "2.2.0-preview1.23462.5")]
    [System.ServiceModel.ServiceContractAttribute(Namespace="http://www.dataaccess.com/webservicesserver/", ConfigurationName="wsNumberConversion.NumberConversionSoapType")]
    public interface NumberConversionSoapType
    {
        
        [System.ServiceModel.OperationContractAttribute(Action="", ReplyAction="*")]
        System.Threading.Tasks.Task<wsNumberConversion.NumberToWordsResponse> NumberToWordsAsync(wsNumberConversion.NumberToWordsRequest request);
        
        [System.ServiceModel.OperationContractAttribute(Action="", ReplyAction="*")]
        System.Threading.Tasks.Task<wsNumberConversion.NumberToDollarsResponse> NumberToDollarsAsync(wsNumberConversion.NumberToDollarsRequest request);
    }
    ...
    public partial class NumberToWordsRequest
    {
        ...
        public wsNumberConversion.NumberToWordsRequestBody Body;
        
        public NumberToWordsRequest()
        {
        }
        
        public NumberToWordsRequest(wsNumberConversion.NumberToWordsRequestBody Body)
        {
            this.Body = Body;
        }
    }
    ...
    public partial class NumberToWordsResponse
    {
        ...
        public wsNumberConversion.NumberToWordsResponseBody Body;
        
        public NumberToWordsResponse()
        {
        }
        
        public NumberToWordsResponse(wsNumberConversion.NumberToWordsResponseBody Body)
        {
            this.Body = Body;
        }
    }
    ...
    public partial class NumberToDollarsRequest
    {
        ...
        public wsNumberConversion.NumberToDollarsRequestBody Body;
        
        public NumberToDollarsRequest()
        {
        }
        
        public NumberToDollarsRequest(wsNumberConversion.NumberToDollarsRequestBody Body)
        {
            this.Body = Body;
        }
    }
    ...
    public partial class NumberToDollarsResponse
    {
        ...
        public wsNumberConversion.NumberToDollarsResponseBody Body;
        
        public NumberToDollarsResponse()
        {
        }
        
        public NumberToDollarsResponse(wsNumberConversion.NumberToDollarsResponseBody Body)
        {
            this.Body = Body;
        }
    }
    ...
    [System.CodeDom.Compiler.GeneratedCodeAttribute("Microsoft.Tools.ServiceModel.Svcutil", "2.2.0-preview1.23462.5")]
    public interface NumberConversionSoapTypeChannel : wsNumberConversion.NumberConversionSoapType, System.ServiceModel.IClientChannel
    {
    }
    
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.CodeDom.Compiler.GeneratedCodeAttribute("Microsoft.Tools.ServiceModel.Svcutil", "2.2.0-preview1.23462.5")]
    public partial class NumberConversionSoapTypeClient : System.ServiceModel.ClientBase<wsNumberConversion.NumberConversionSoapType>, wsNumberConversion.NumberConversionSoapType
    {
        ...
        [System.ComponentModel.EditorBrowsableAttribute(System.ComponentModel.EditorBrowsableState.Advanced)]
        System.Threading.Tasks.Task<wsNumberConversion.NumberToWordsResponse> wsNumberConversion.NumberConversionSoapType.NumberToWordsAsync(wsNumberConversion.NumberToWordsRequest request)
        {
            return base.Channel.NumberToWordsAsync(request);
        }
        
        public System.Threading.Tasks.Task<wsNumberConversion.NumberToWordsResponse> NumberToWordsAsync(ulong ubiNum)
        {
            wsNumberConversion.NumberToWordsRequest inValue = new wsNumberConversion.NumberToWordsRequest();
            inValue.Body = new wsNumberConversion.NumberToWordsRequestBody();
            inValue.Body.ubiNum = ubiNum;
            return ((wsNumberConversion.NumberConversionSoapType)(this)).NumberToWordsAsync(inValue);
        }
        
        [System.ComponentModel.EditorBrowsableAttribute(System.ComponentModel.EditorBrowsableState.Advanced)]
        System.Threading.Tasks.Task<wsNumberConversion.NumberToDollarsResponse> wsNumberConversion.NumberConversionSoapType.NumberToDollarsAsync(wsNumberConversion.NumberToDollarsRequest request)
        {
            return base.Channel.NumberToDollarsAsync(request);
        }
        
        public System.Threading.Tasks.Task<wsNumberConversion.NumberToDollarsResponse> NumberToDollarsAsync(decimal dNum)
        {
            wsNumberConversion.NumberToDollarsRequest inValue = new wsNumberConversion.NumberToDollarsRequest();
            inValue.Body = new wsNumberConversion.NumberToDollarsRequestBody();
            inValue.Body.dNum = dNum;
            return ((wsNumberConversion.NumberConversionSoapType)(this)).NumberToDollarsAsync(inValue);
        }
